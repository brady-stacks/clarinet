...
pub const DEFAULT_STACKS_NODE_IMAGE: &str = "blockstack/stacks-blockchain:3.3.0.0.4-alpine";
pub const DEFAULT_STACKS_SIGNER_IMAGE: &str = "blockstack/stacks-signer:3.3.0.0.4.0-alpine";
...
pub const DEFAULT_EPOCH_3_4: u64 = 148; // TODO: Update with actual Epoch34 default when available
